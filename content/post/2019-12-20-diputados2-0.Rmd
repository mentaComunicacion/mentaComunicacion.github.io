---
title: Diputados2.0. Una radiografía del ecosistema legislativo en Twitter
author: ~
date: '2019-12-20'
slug: diputados2-0
categories: []
...
Tal como hicieramos respecto a las cuentas de legisladores pertenecientes al Senado de la Nación ([disponible acá](https://mentacomunicacion.github.io/2019/12/12/senado2-0/)), en los siguientes apartados nos proponemos hacer una *radiografía* de la Cámara de Diputados. 
...
Además de las observaciones inidviduales los gráficos de cajas muestran la distribución. La línea horizontal representa la mediana de cada uno de los indicadores. 
...
* `sergiomassa`  es también el más *seguidor* con $146$ de sus pares entre sus *follows*. Lo secunda `_alvarogonazalez` con $98$. 
...
(*Figura en alta resolución disponible [acá](https://raw.githubusercontent.com/mentaComunicacion/data_posts/master/congreso2.0/figs/PCA_dip.png)*)
...
En tanto, al observar el sub espacio de **Juntos por el Cambio** se observa una distribución bastante centrada de la nube amarilla con mimebros de las distintas fuerzas que lo componen (PRO, CC y UCR) con algunas cuentas más alejadas como `lucilalehmann`, `sebasnsalvador`, `alvarodlamadrid` y `dinarezi`. 
...
La mayor parte de las cuentas identificadas como *Otros* se ubican en una posición intermedia donde se cruzan las nubes de los dos espacios principales. Allí se observa por ejemplo a `rominadelpla` y `nicolasdelcano` del Frente de Izquierda y a mimebros de bloques menores como `paulocassinerio`, `almasapag` y `joseluisramon` (más aislado del resto de sus colegas).
